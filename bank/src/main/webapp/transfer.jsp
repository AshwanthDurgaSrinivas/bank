...
<body>
   <form action="transferservelet" method="post">
    <div class="deposit-container">
        <h3>Transfer</h3>
        <input type="text" id="account-number" name="account-number" placeholder="Enter receiver Account number" required>
        <input type="number" id="amount" name="amount" placeholder="Enter the Amount" required>
        <input type="text" id="password" name="password" placeholder="Enter your password" required>
        <button type="submit" id="deposit-btn">Transfer</button>
